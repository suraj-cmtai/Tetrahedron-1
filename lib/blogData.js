...
"how-does-energy-efficiency-beneficial-for-healthcare": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "To know more, visit – https://www.tetrahedron.in/iso-50001-enms/"
        ]
      }
    ],
    cta: {
  ...
  id: 24,
    ...
    sections: [
      ...
      },
      {
        heading: "How does ISO 50001 work?",
        content: [
          "1. ISO 50001 EnMS is a standard for energy management systems that provides organizations with a framework to improve their energy efficiency and reduce their energy costs. Here’s how it works:",
          "2. Establish an Energy Policy: The first step in implementing ISO 50001 is to establish an energy policy that outlines the organization’s commitment to energy management and energy efficiency. This policy should be communicated to all employees and stakeholders.",
          ...
          "5. Set Energy Objectives and Targets: Based on the energy review, the organization should set energy objectives and targets that are measurable, achievable, and aligned with the organization’s energy policy. These objectives and targets should be communicated to all employees and stakeholders.",
  ...
  "ar-vr-for-industries": {
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          "Both technologies have found applications in manufacturing, healthcare, commerce and education. This is far from the end of the list of areas where augmented reality and virtual reality are used as useful tools – not just proof of concept – making tangible contributions to business development."
        ]
      },
      {
  ...
  "energy-audit": {
    ...
    sections: [
      ...
      { 
        heading: "Reduce your energy consumption by 10–20%.",
        content: [
    ...
    sections: [
      ...
      },
      {
        content: [
          ...
          "It is aligned with processes CQS (COST, QUALITY, SAFETY) i.e, Cost of raw material, labor cost, overhead, profit margin; Quality includes – management, labor, and motivation; Safety includes Personnel, Asset of organization and Environment factors also it covers emergency area and training."
        ]
      }
    ],
    cta: {
  ...
  "do-you-know-about-lean-house-and-5-lean-principles-of-manufacturing": {
    ...
    sections: [
      ...
      {
        content: [
          "Next, we have two pillars of the lean house –",
          "JIT",
          "JIDOKA",
      ...
      },
      {
        content: [
          ...
          "Man-machine separation and automation – For the JIDOKA pillar"
        ]
      },
      {
        content: [
      ...
      },
      {
        ...
        content: [
          "Value – This is decided by aligning with customer needs and requirements. It is important to consider all the things, like time of delivery, manufacturing cost, expectations of customers met or not, etc.",
          "Value stream – After deciding the value, mapping the value stream is the next step. This includes all the steps that are involved in the making of the final product. Right from collecting the raw material to delivering the final packaged product, all the processes are mapped. This is what helps to eradicate the processes and the steps that create waste during the process. The business operation is understood in a better manner with this and this is also sometimes termed as the process re-engineering.",
          "Flow – Once the waste has been eradicated; the other remaining process must be smooth. This simply means that no delays, no interruptions, and no bottlenecks in product manufacturing. To get a smooth flow, it is important that you design the value-creating steps in the right and strict sequence so that the efficiency is maximum.",
          "Pull – Now once the manufacturing is smooth, the next crucial thing is to be available to customers on time. The easier it is for customers to pull the products from you, the more would be the market. Also, the stockpiling problem would never arrive if the pull is managed properly.",
          "Perfection – Though you have completed all of the steps properly this is the most important which cannot be ignored. At this point, it is important to understand that the lean system is not static. You need constantly to make efforts and vigilance to perfect."
        ]
      },
      {
        content: [
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Physical Ergonomics – It is the Human Body's responses to physical and physiological work Loads.",
          "Cognitive Ergonomics – It deals with the mental process of humans when at work.",
          "Organizational Ergonomics – Includes the organizational structures, policies, and processes in the work environment.",
    ...
    sections: [
      ...
      },
      {
        ...
        content: [
          ...
          "Many financial Owners find their current data far from ideal, and not delivering the transparency or insights they need."
        ],
        image: "/images/blog/cost-reduction-and-budget.jpg"
      },
      {
        ...
        content: [
          "Getting cost data to a more granular level helps managers support strategic decision-making—from customer segmentation to operations accountability.",
          ...
          "More than 50% of surveyed financial Owners either capture or wish to capture cost data at granular levels like customers or channels.",
          "However, satisfaction with profitability metrics tends to drop as data granularity increases—often due to difficulty linking overhead costs, or inadequate tools to manage detailed data."
        ]
      },
      {
