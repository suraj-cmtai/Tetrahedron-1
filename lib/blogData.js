...
export const blogPages = {
  ...
  "maximizing-performance-with-operational-excellence": {
    title: "Maximizing Performance with Operational Excellence: Tools and Techniques for Manufacturing Firms",
    image: getImageBySlug("maximizing-performance-with-operational-excellence"),
    sections: [
      {
...
"how-does-energy-efficiency-beneficial-for-healthcare": {
  ...
  "ergonomics-dojo": {
    ...
    image: getImageBySlug('ergonomics-dojo'),
    sections: [
      {
