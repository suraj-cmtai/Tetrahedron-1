...
export const consultingPages = {
  "tpm-consultants": {
    ...
    img: "/images/servicesData/5.jpeg?id=28655",
    ...
    industries: [ // Array of image URLs
      "/images/servicesData/WhatsApp-Image-2024-06-13-at-4.11.01-PM.jpeg",
      "/images/servicesData/WhatsApp-Image-2024-06-13-at-4.11.01-PM-1.jpeg",
      "/images/servicesData/WhatsApp-Image-2024-06-13-at-4.11.01-PM-2.jpeg",
      "/images/servicesData/WhatsApp-Image-2024-06-13-at-4.11.01-PM-3.jpeg",
    ],
  ...
  "tqm-consultants": {
    ...
    img: "/images/servicesData/Banner-Image_-A-Path-to-Excellence-TQM_-1.jpg?id=29955",
    ...
    industries: [
      ...
      "/images/servicesData/Screenshot-2024-07-19-112150-1-2-1024x751.png",
  ...
  "lean-manufacturing-consultants": {
    ...
    img: "/images/servicesData/fhgjjlhjhg-1-1.jpg?id=30022",
  ...
  "manufacturing-operational-excellence-consulting": {
    ...
    img: "/assets/images/backgrounds/page-header-bg1.jpg",
  ...
  "iso-certification-consultants": {
    ...
    img: "/images/servicesData/ISO-Certification-Consultants.jpg?id=23413",
    bannerTitle: "ISO CERTIFICATION CONSULTANTS",
    bannerSubtitle: "Make Your Organization ISO Certified",
    bannerDescription:
      "Tetrahedron provides the best ISO consulting services and leading ISO Consultants in India, helping your organization achieve ISO certification to enhance credibility, improve quality, safeguard the environment, and ensure workplace safety. Our ISO implementation services are designed to drive business growth, customer satisfaction, and international recognition.",
    introText:
      "ISO certification is a mark of quality, consistency, and global competitiveness. By implementing ISO standards, organizations can improve their processes, reduce risks, enhance customer satisfaction, and demonstrate their commitment to excellence. Tetrahedron’s expert consultants guide you through every step of the ISO implementation journey, ensuring a smooth, value-driven, and sustainable transformation.",
    whyChoose: {
      title: "Why Choose Tetrahedron for ISO Certification?",
      content:
        "Tetrahedron’s ISO consultants bring deep expertise across a wide range of standards, including ISO 9001 (Quality), ISO 14001 (Environment), ISO 45001 (Safety), ISO 50001 (Energy), ISO 13485 (Medical Devices), and ISO 22000 (Food Safety). We tailor our approach to your business needs, focusing on practical implementation, employee engagement, and long-term value. Our proven methodology ensures not just certification, but real operational improvement.",
      subTitle: "Ready to Achieve ISO Certification?",
      subText: "Contact us to discuss how ISO standards can drive your business growth and global competitiveness.",
    },
    pillars: [
      {
        title: "Standardization",
        content: "Establish consistent processes and best practices across your organization, reducing variability and improving reliability.",
      },
      {
        title: "Customer Satisfaction (ISO 9001:2015)",
        content: "Meet and exceed customer requirements by implementing a robust Quality Management System.",
      },
      {
        title: "Process Improvement",
        content: "Describe, understand, and communicate your company’s processes to drive continual improvement and efficiency.",
      },
      {
        title: "Operational Consistency",
        content: "Improve the consistency of your operations, products, and services, reducing errors and rework.",
      },
      {
        title: "Energy Efficiency (ISO 50001:2018)",
        content: "Optimize energy use, reduce waste, and save money through systematic energy management.",
      },
      {
        title: "Collaboration & Recognition",
        content: "Facilitate business collaboration and gain international recognition with globally accepted standards.",
      },
      {
        title: "Workplace Safety (ISO 45001:2018)",
        content: "Enhance workplace safety, reduce occupational illness, and mitigate process risks.",
      },
      {
        title: "Specialized Standards",
        content: "Implement sector-specific standards such as ISO 13485 (Medical Devices) and ISO 22000 (Food Safety) for compliance and market access.",
      },
    ],
    features: [
      {
        ...
        desc: "ISO certification demonstrates your commitment to quality, safety, and environmental responsibility.",
      },
      {
        icon: "Smile",
        title: "Customer Satisfaction",
        desc: "Consistently meet customer requirements and improve satisfaction with certified processes.",
      },
      {
        icon: "TrendingUp",
        title: "Business Growth",
        desc: "Leverage ISO standards to access new markets, win more contracts, and drive sustainable growth.",
      },
      {
        icon: "Globe",
        title: "International Recognition",
        desc: "Gain global recognition and facilitate easier collaboration with international partners.",
      },
      {
        icon: "ShieldCheck",
        title: "Risk Reduction",
        desc: "Identify, assess, and mitigate risks to ensure business continuity and compliance.",
      },
      {
        icon: "Leaf",
        title: "Environmental Stewardship",
        desc: "Reduce your environmental impact and demonstrate your commitment to sustainability.",
      },
      {
        icon: "Zap",
        title: "Operational Efficiency",
        desc: "Streamline processes, reduce waste, and improve resource utilization.",
      },
      {
        icon: "Users",
        title: "Employee Engagement",
        desc: "Empower employees with clear processes, training, and a culture of continuous improvement.",
      },
    ],
    isoStandards: {
      title: "ISO Implementation Done By Tetrahedron",
      items: [
        {
          title: "ISO 9001:2015",
        ...
        },
        {
          ...
          desc: "Environment Management System",
        },
        {
          title: "ISO 45001:2018",
          desc: "Safety Management System",
        },
        {
          title: "ISO 50001:2018",
          desc: "Energy Management System",
        },
        {
        ...
        {
          title: "ERM",
          desc: "Enterprise Risk Management System Implementation",
        },
      ],
    },
    implementationProcess: {
      title: "Our ISO Consulting Approach",
      process: [
        "Gap Assessment: Evaluate current processes and identify gaps against relevant ISO standards.",
        "Roadmap & Planning: Develop a tailored implementation plan with clear milestones and responsibilities.",
        "Documentation & Standardization: Create and update required policies, procedures, and records.",
        "Training & Awareness: Equip employees with the knowledge and skills needed for effective implementation.",
        "Implementation Support: Guide your team through process changes and best practices.",
        "Internal Audit: Conduct audits to verify compliance and readiness for certification.",
        "Certification Support: Liaise with certification bodies and support you through the external audit process.",
        "Continual Improvement: Establish systems for ongoing monitoring, review, and improvement.",
      ],
      image: "/images/servicesData/ISO-Implementation.png",
    },
    clients: {
    ...
    faq: {
      ...
      items: [
        {
          question: "Which ISO standard is right for my organization?",
          answer: "The appropriate ISO standard depends on your industry, goals, and customer requirements. Common standards include ISO 9001 (Quality), ISO 14001 (Environment), ISO 45001 (Safety), ISO 50001 (Energy), ISO 13485 (Medical Devices), and ISO 22000 (Food Safety).",
        },
        {
          question: "How long does ISO certification take?",
          answer: "The timeline varies based on your organization’s size, complexity, and readiness. Typical implementation projects range from 3 to 12 months.",
        },
        {
          question: "What are the main benefits of ISO certification?",
          answer: "ISO certification improves process consistency, customer satisfaction, risk management, market access, and operational efficiency.",
        },
        {
          question: "Do you provide support during the certification audit?",
          answer: "Yes, Tetrahedron supports you throughout the entire process, including preparation for and support during the external certification audit.",
        },
        {
          question: "Can ISO standards be integrated?",
          answer: "Absolutely. Many organizations implement integrated management systems (IMS) to combine multiple ISO standards for greater efficiency and synergy.",
        },
      ],
    },
  },
  "visual-management-consultants": {
    ...
    img:"/images/servicesData/Untitled-design-7.jpg?id=28428",
  ...
  "manufacturing-excellence": {
    title: "Manufacturing Excellence Consulting",
    img: "/images/servicesData/fhgjjlhjhg-1-1.jpg?id=30022",
    bannerTitle: "MANUFACTURING EXCELLENCE CONSULTING",
    bannerSubtitle: "Drive World-Class Performance Through Lean Principles",
    bannerDescription:
      "Manufacturing Excellence is about building a culture and system of continuous improvement, operational discipline, and best-in-class performance by leveraging proven Lean tools and methodologies.",
    introText:
      "Our Manufacturing Excellence services empower organizations to achieve breakthrough results in productivity, quality, cost, and delivery. We help you implement Lean principles such as Value Stream Mapping, 5S, Just-in-Time, Kanban, and Standardized Work to create a high-performance, waste-free manufacturing environment.",
    whyChoose: {
      title: "Why Pursue Manufacturing Excellence?",
      content: "Manufacturing Excellence enables organizations to systematically eliminate waste, reduce costs, improve quality, and increase agility. By embedding Lean thinking and continuous improvement into your culture, you can sustain competitive advantage and deliver greater value to your customers.",
      subTitle: "Ready to Transform Your Manufacturing Operations?",
      subText: "Let's build your journey to world-class manufacturing together.",
    },
    pillars: [
      {
        title: "Value Stream Mapping (VSM)",
        content: "Visualize and analyze your end-to-end processes to identify waste and design a future state that maximizes value and flow.",
      },
      {
        title: "5S Workplace Organization",
        content: "Establish a clean, organized, and disciplined workplace to reduce waste, improve safety, and boost morale.",
      },
      {
        title: "Just-In-Time (JIT) / Kanban",
        content: "Implement pull systems to produce only what is needed, when it is needed, minimizing inventory and lead times.",
      },
      {
        title: "Waste Elimination (Muda)",
        content: "Target the 7+1 wastes (Defects, Overproduction, Waiting, Non-Utilized Talent, Transportation, Inventory, Motion, Over-Processing) to drive efficiency.",
      },
      {
        title: "Continuous Improvement (Kaizen)",
        content: "Foster a culture where everyone is engaged in identifying and implementing improvements every day.",
      },
      {
        title: "Standardized Work",
        content: "Document and sustain the best way to perform each task, ensuring consistency and enabling further improvement.",
      },
    ],
    features: [
      { icon: "TrendingDown", title: "Cost Reduction", desc: "Achieve 15-30% cost savings by eliminating waste and optimizing processes." },
      { icon: "Zap", title: "Productivity Boost", desc: "Increase throughput and efficiency by streamlining workflows and removing bottlenecks." },
      { icon: "Layers", title: "Inventory Optimization", desc: "Reduce inventory levels and free up working capital with JIT and Kanban." },
      { icon: "Clock", title: "Faster Lead Times", desc: "Respond quickly to customer demand by reducing cycle times and improving flow." },
      { icon: "CheckSquare", title: "Quality Improvement", desc: "Lower defects and rework by building quality into every process step." },
      { icon: "Maximize2", title: "Space Utilization", desc: "Maximize your facility's footprint through better organization and flow." },
    ],
    clients: {
    ...
    faq: {
      title: "Manufacturing Excellence FAQs",
      items: [
        { question: "What is Manufacturing Excellence?", answer: "Manufacturing Excellence is a holistic approach to achieving world-class performance by embedding Lean principles, continuous improvement, and operational discipline throughout the organization." },
        { question: "How is Manufacturing Excellence different from Lean?", answer: "Lean is a core methodology within Manufacturing Excellence. Manufacturing Excellence also encompasses leadership, culture, and systems to sustain and amplify Lean improvements." },
        { question: "What are the first steps to Manufacturing Excellence?", answer: "Start with a current state assessment, identify key wastes and improvement opportunities, and engage leadership and teams in Lean training and pilot projects." }
      ]
    }
  },
  "plant-layout-design": {
    title: "Plant Layout Design Consultants",
    img:"/images/servicesData/Untitled-design-44-1.jpg?id=30013",
    ...
    implementationProcess: { // Using similar structure to 'certification' or VM's implementation
      ...
      image: "/images/servicesData/LEAN-PLANT-LAYOUT-DEVELOPMENT-APPROACH.jpg", // Added image associated with process
    },
      ...
      items: [
        {
          ...
          img: "/images/servicesData/Untitled-design-2-2-1.jpg",
        },
        {
          ...
          img: "/images/servicesData/WhatsApp_Image_2024-07-23_at_3.26.20_PM-removebg-preview.png",
        },
        {
          ...
          img: "/images/servicesData/MEP-Engineering-and-Design-Services-768x538.png",
        },
        {
          ...
          img: "/images/servicesData/future-changes.jpg",
        },
        {
  ...
  "dojo-training-center": { // New entry
    title: "Dojo Training Center", // Matches format
    img:"/images/servicesData/Untitled-design-25.jpg?id=29158", // Matches format
  ...
  "dojo-2-0": { // New entry for Dojo 2.0
    ...
    comparisonDojo1vs2: {
      ...
      image: "/images/servicesData/WhatsApp-Image-2024-03-14-at-5.52.21-PM-900x577.jpeg", // Comparison image URL
    ...
    implementationProcess: { // Matches format {title, process[], image?}
      ...
      image: "/images/servicesData/Screenshot-2024-06-01-at-11.54.35%E2%80%AFAM-725x1024.png", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable as no specific case study data provided.
  ...
  "mini-dojo-training-center": { // New entry for Mini Dojo
    ...
    implementationProcess: { // Matches format {title, process[], image?}
      ...
      image: "/images/servicesData/WhatsApp-Image-2024-06-10-at-10.51.26-AM.jpeg", // Relevant image URL
    },
  ...
  "dwm-and-time-management-techniques": { // New entry for DWM & Time Management Training
  ...
  "safety-consultants": { // New entry for Safety Consultants
    title: "Safety Consultants", // Matches format
    img:"/images/servicesData/safety-consultants.webp?id=29761", // Matches format
    ...
    implementationProcess: { // Matches format {title, process[], image?}
      ...
      image: "/images/servicesData/SYSTEM-SAFETY.png", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
  ...
  "iso-9001-qms": { // New entry for ISO 9001 QMS
    title: "ISO 9001 QMS Consultants", // Matches format
    img:"/images/servicesData/ISO-Certification-Consultants.jpg?id=23413", // Matches format
    ...
    implementationProcess: { // Matches format {title, process[], image?}
      ...
      image: "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
    ...
    coreConcepts: {
      ...
      image: "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Image for concepts
      items: [ // Array of objects {title, desc}
        {
  ...
  "iso-50001-enms": { // New entry for ISO 50001 EnMS
    ...
    clients: { // Using the generic client logo format
      ...
      image: "/images/servicesData/WhatsApp-Image-2023-03-03-at-14.37.36-jpg.webp", // Standard client logo image
    },
    faq: { // Matches format {title, items[]}
  ...
  "energy-audit-and-efficiency-services": { // New entry for Energy Audit
    title: "Energy Audit and Efficiency Services", // Matches format
    img:"/images/servicesData/Energy-saving-1-2.png?id=21536", // Matches format
    ...
    auditTypes: {
      ...
      image: "/images/servicesData/Untitled-design-19.png", // Relevant image URL
      items: [
        {
    ...
    implementationProcess: { // Matches format {title, process[], image?}
      ...
      image: "/images/servicesData/energy-saving.jpg", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
  ...
  "automated-guided-vehicle-manufacturers": { // New entry for AGV Solutions
    ...
    img:"/images/servicesData/Untitled-design.png?id=20925", // Matches format
      ...
      items: [ // Array of objects {title, desc, img}
        {
          ...
          img: "/images/servicesData/A_Autonomous_mo_1-transformed-300x300.png",
        },
        {
          ...
          img: "/images/servicesData/0975fea1-43f2-47a6-8895-3bdcf636f94a-300x300.png",
        },
        {
          ...
          img: "/images/servicesData/Autonomous-Mobile-Robots-14.png",
        },
        {
          title: "Forklift AGVs",
        ...
        },
        {
          ...
          img: "/images/servicesData/360-degree-camera.png",
        }
      ]
    },
    ...
    implementationProcess: { // Matches format {title, process[], image?} - Adapted for Consulting/Integration
      ...
      image: "/images/servicesData/WhatsApp-Image-2024-06-14-at-4.49.32-PM.jpeg", // Relevant image URL
    },
    // 'caseStudy' and 'outcomes' keys not applicable.
...
export const skillTrainingData = {
  ...
  "advanced-product-quality-planning": { // New entry for APQP Training
      ...
      "pillars": [ // Using 'pillars' for the 5 Phases of APQP
        ...
        { "image" :"/images/servicesData/Add-a-heading-2.jpg", "isImage": true }, // Specific image found on page: apqp-phases.jpg
        {
      ...
      "methodology": {
        ...
        "image" :"/images/servicesData/Add-a-heading-2.jpg", // Specific image found on page: training-methodology.jpg
        "points": [ // List of methodology points
  ...
  //missing part
  "measurement-system-analysis-msa": { // New entry for MSA Training
      // Mapping training content to the consulting structure where possible, adding new keys as needed.
      "title": "Measurement System Analysis (MSA) Training", // From page <title> and H1
      "image": "/assets/images/backgrounds/page-header-bg1.jpg", // From page header background style (assuming standard)
  ...
  // --2
  "design-fmea": { // New entry for DFMEA Training
    title: "Design FMEA (DFMEA) Training", // Matches format
    image:"/images/servicesData/Untitled-design-jpg.webp?id=25769", // Matches format
    ...
    courseContent: {
      ...
      image :"/images/servicesData/Design-fmea.jpg1_-768x432.jpg",
      modules: [ // List of modules/topics from page
    ...
    clients: { // Using the generic client logo format
      ...
      image: "/images/servicesData/Training-clients-jpg.webp", // Standard client logo image
    },
  ...
  //--3
  "process-failure-mode-effect-analysis-pfmea": { // New entry for PFMEA Training
    ...
    courseContent: {
      ...
      // Image related to course content/process
      image :"/images/servicesData/Lk-and-Fb-Posts-43-768x432.jpg",
      modules: [ // List of modules/topics from page
    ...
    methodology: {
      title: "Training Methodology",
      image :"/images/servicesData/Design-fmea.jpg1_-768x432.jpg", // Standard methodology image
      points: [ // List of methodology points
  ...
  "statistical-process-control": { // New entry for SPC Training
    ...
    courseContent: {
      ...
      image :"/images/servicesData/SPC-768x432.jpg",
      modules: [ // List of modules/topics from page
  ...
  "geometric-dimensioning-and-tolerancing": { // New entry for GD&T Training
    ...
    methodology: {
      title: "Training Methodology",
      image :"/images/servicesData/GDT-768x432.jpg", // Standard methodology image
      points: [ // List of methodology points
  ...
  //---6
  "advanced-gd-and-t-training": { // New entry for Advanced GD&T Training
  ...
  "inventory-management": { // New entry for Inventory Management Training
  ...
  //--8
  "production-part-approval-process": { // New entry for PPAP Training
  ...
  //--9
  "industry-4-0-courses": { // New entry for Industry 4.0 Training
  ...
  //--10
  "industry-5-0": {
    title: "Industry 5.0 Training",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "INDUSTRY 5.0",
    bannerSubtitle: "The Next Industrial Revolution: Mass Personalization & Human-Centric Manufacturing",
    bannerDescription:
      "Industrial Revolution 5.0, known as Industry 5.0, is evolving to focus on the personalized demands of customers. This paradigm provides advanced computing power to facilitate digital manufacturing systems that communicate seamlessly with other systems. With mass personalization, Industry 5.0 delivers customer delight and higher value addition.",
    introText:
      "Industry 5.0 represents the next leap in industrial transformation, emphasizing the synergy between humans and advanced technologies to deliver highly personalized products and services. This training explores the integration of smart sensors, smart materials, the Internet of Everything, holography, and 5D printing, equipping participants to lead their organizations into the era of mass customization and digital intelligence.",
    whyChoose: {
      title: "Why Choose Tetrahedron for Industry 5.0 Training?",
      content: "Tetrahedron’s Industry 5.0 training is designed to help organizations and professionals understand and implement the latest advancements in digital manufacturing, smart materials, and human-machine collaboration. Our expert-led sessions provide actionable insights, real-world case studies, and strategic frameworks to help you harness the full potential of Industry 5.0 for competitive advantage.",
      subTitle: "Ready to embrace the future of personalized manufacturing?",
      subText: "Join our Industry 5.0 training to unlock new value for your business and customers.",
    },
    targetAudience: {
    ...
    features: [
      {
        icon: "SmilePlus", // Lucide icon guess for customer delight
        title: "Mass Personalization",
        desc: "Enables customers to receive products and services tailored to their specific requirements, enhancing satisfaction and loyalty."
      },
      {
        icon: "Cpu", // Lucide icon guess for digital/AI
        title: "AI-Driven Manufacturing",
        desc: "Deploys artificial intelligence to optimize processes and fulfill the promise of personalized production."
      },
      {
        icon: "BarChart3", // Lucide icon guess for strategy/insight
        title: "Strategic Digital Insights",
        desc: "Provides digital information to inform competitive and corporate strategy in the Industry 5.0 era."
      },
      {
        icon: "AlertTriangle", // Lucide icon guess for challenges
        title: "Barrier Identification",
        desc: "Helps organizations identify and address challenges during Industry 5.0 implementation."
      },
      {
        icon: "CheckCircle2", // Lucide icon guess for value
        title: "Enhanced Organizational Performance",
        desc: "Evaluates current systems and develops a deep understanding of how Industry 5.0 can drive organizational success."
      },
      {
        icon: "PackageCheck", // Lucide icon guess for customer expectations
        title: "Customer-Centric Production",
        desc: "Empowers manufacturing industries to meet and exceed customer expectations through advanced personalization."
      }
    ],
    courseObjective: {
      title: "Course Objective",
      points: [
        "Understand the concepts of smart sensors in the manufacturing industry.",
        "Learn about smart materials applications in manufacturing.",
        "Understand the meaning and impact of the Internet of Everything.",
        "Explore applications of Holography and 5D printing."
      ]
    },
    courseContent: {
      title: "Industry 5.0 Training Outline",
      modules: [
        ...
        "   – Introduction to Collaborative Robots (Co-bots)",
        "   – Controlled Robot to Collaborative Robots (Co-bot)",
        "   – Chatbots",
        "   – Application of co-bots in welding, assembly & material handling operations",
        ...
        "   – Microsoft Holo Lens, Google Glass",
        ...
        "   – Application of Big Data across industries and sectors",
        ...
        "   – Using Simulation for prototype development, testing, lifecycle management, and business decisions",
        "   – Case Study",
        "9. Robotics Process Automation (RPA) in Digital Factory",
        "   – What is RPA",
        "   – How it can change the way HR & Finance work in a digital factory",
        "   – Introduction to Task Bots, Meta Bots & IQ Bots",
        ...
        "   – Discussion on recent major industrial cyber security attacks",
        "   – Responsibility for making a safe & secure system",
        "11. Making Blue-Print for Industry 4.0",
        "   – Industry 4.0 Vision 2020",
        "   – SWOT and GAP analysis for competition and innovation",
    ...
    methodology: {
      ...
      points: [
        ...
        "Hands-on analysis of smart sensors, materials, and digital technologies",
        "Case studies on Industry 5.0 implementation",
        "Group activities and scenario-based exercises",
        "Q&A sessions and knowledge sharing"
      ]
    },
    clients: {
      title: "Empowering Organizations for the Next Industrial Revolution",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },

  //--11
  "virtual-reality": { // New entry for Virtual Reality Courses
    title: "Virtual Reality Courses", // Matches format
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Matches format
    bannerTitle: "VIRTUAL REALITY COURSES | AR & VR TRAINING", // Matches format
    bannerSubtitle: "Immersive Learning for the Future of Industry", // Enhanced subtitle
    bannerDescription:
      "Virtual reality (VR) is a computer-generated scenario that simulates a realistic experience. The immersive environment can be similar to the real world in order to create a lifelike experience grounded in reality or sci-fi.\n\nVirtual reality technology has enabled humans to face anything at any place at any point in time. It feels like we are in a virtual world and feels the earth around us reasonably.", // Adapted from prompt
    introText:
      "Virtual reality courses are among the most highly requested skill sets in the job market, especially as VR becomes increasingly vital in the manufacturing industry and beyond. This specialization introduces you to the fundamentals of VR, key development skills, and hands-on experience with industry-standard tools like Unity. Participants will learn from world-leading professionals and industry experts, use Unity to develop their own VR environments, and finish by creating their first VR game or project.", // Adapted from prompt
    whyChoose: {
      title: "Why Choose Tetrahedron for Virtual Reality Training?",
      content: "Tetrahedron's VR training is designed to bridge the gap between theoretical knowledge and practical application. Our workshops are led by experienced professionals who guide participants through the latest VR technologies, development platforms, and real-world applications. Whether you're looking to upskill your team or explore new possibilities in immersive technology, our courses provide the expertise and resources you need.",
      subTitle: "Ready to step into the world of Virtual Reality?",
      subText: "Join our VR training to gain hands-on experience and future-ready skills.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
        ...
        "Learn the basics of 3D graphics, how to create objects, and how to lay them out to create an environment.",
        "Understand the different platforms currently available for VR development.",
        "Gain a basic understanding of the Unity platform interface and how to view, inspect, and use it."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
    ...
    features: [ // Using "Benefits of Attending" as features
      {
        icon: "Star", // Lucide icon guess
        title: "In-Demand Skills",
        desc: "Gain key skills in VR development, one of the most sought-after areas in today's job market.",
      },
      {
        icon: "Users", // Lucide icon guess
        title: "Expert-Led Training",
        desc: "Learn from world-leading professionals and industry experts in immersive technology.",
      },
      {
        icon: "Gamepad", // Lucide icon guess
        title: "Hands-On Projects",
        desc: "Use Unity to develop your own VR environment and create your first VR game or project.",
      },
      {
        icon: "Eye", // Lucide icon guess
        title: "Fundamental Understanding",
        desc: "Discover the fundamentals of VR, including hardware, history, applications, and the psychology of the medium.",
      },
      {
        icon: "Layers", // Lucide icon guess
        title: "Future-Ready Applications",
        desc: "Explore the future possibilities of VR across various industries and advanced visualization scenarios.",
      },
      {
        icon: "Briefcase", // Lucide icon guess
        title: "Industry Relevance",
        desc: "VR skills are highly valued in manufacturing, engineering, and many other sectors.",
      }
    ],
    modules: { // Workshop Modules / Training Outline
      ...
      items: [
        {
          ...
          points: [
            ...
            "Birds-eye view (general, hardware, software, sensation and perception)"
          ]
        },
        {
          title: "2. Geometry of Virtual Worlds 1",
          points: [
            "Geometric modelling",
            "Transforming models",
        ...
        {
          title: "3. Geometry of Virtual Worlds 2",
          points: [
        ...
        {
          title: "5. Visual Physiology",
          points: [
            "Photoreceptors",
            "Sufficient resolution for Virtual Reality",
            "Light intensity",
            "Eye movements",
            "Eye movement issues for Virtual Reality",
            "Neuroscience of vision"
          ]
        },
        {
          title: "6. Visual Perception",
          points: [
            "Depth perception",
            "Motion perception",
        ...
        },
        {
          ...
          points: [
            ...
            "System control",
            "Social interaction",
            "Evaluation of VR Systems Starts",
            "Causes of accidents",
            "Permit-to-work"
          ]
        }
    ...
    brochure: {
      title: "To Get Course Outline and Reference Material",
      content: "Refer to the complete list of 350+ Training modules or contact us for a detailed brochure."
    },
    clients: {
      title: "Empowering Organizations with Immersive Technology",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "design-of-experiment": {
    title: "Design of Experiment Training Courses",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "DESIGN OF EXPERIMENT TRAINING COURSES | DOE",
    bannerSubtitle: "Optimizing Quality, Process, and Product Performance",
    bannerDescription:
      "Design of Experiments (DOE) is a powerful methodology for solving problems, optimizing processes, designing products, and driving improvements in manufacturing and engineering. DOE is widely applied for root cause quality analysis, developing robust and optimized designs, and building analytical models to forecast system behavior. This course provides a comprehensive foundation in DOE, from fundamentals to practical application using tools like Minitab.",
    introText:
      "The Design of Experiments (DOE) training course equips participants with the knowledge and skills to plan, conduct, and analyze experiments that drive breakthrough improvements in process efficiency and product quality. Whether you are developing new products, optimizing existing processes, or troubleshooting quality issues, DOE provides a structured approach to identify critical factors, optimize variables, and achieve robust, data-driven results.",
    whyChoose: {
      title: "Why Choose Tetrahedron for Design of Experiments Training?",
      content: "Tetrahedron's DOE training is led by experienced practitioners who blend theory with hands-on exercises and real-world case studies. Our approach ensures participants not only understand the statistical concepts but also gain practical skills in applying DOE to solve complex problems and optimize outcomes. We emphasize robust design, effective use of statistical software (like Minitab), and actionable insights for immediate workplace impact.",
      subTitle: "Ready to unlock the power of experimentation?",
      subText: "Join our DOE training to master the tools and techniques for process and product optimization.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
    ...
    features: [
      {
        ...
        desc: "Design experiments to identify the optimum combination to minimize cost and increase quality and productivity."
      },
      {
        icon: "ShieldCheck",
        title: "Robust Processes",
        desc: "Improve process or product robustness and reduce variability."
      },
      {
        icon: "BarChart2",
        title: "Data-Driven Decisions",
        desc: "Analyze and interpret results from full and partial factorial DOE to make informed decisions."
      },
      {
        icon: "Award",
        title: "Quality Improvement",
        desc: "Improve the quality of products by optimizing variables and reducing material waste."
      },
      {
        icon: "TrendingUp",
        title: "Increased Productivity",
        desc: "Increase productivity by reducing quality problems and identifying critical process parameters."
      },
      {
        icon: "DollarSign",
        title: "Cost Reduction",
        desc: "Reduce the cost of production by detecting quality problems faster and minimizing rejects."
      }
    ],
    modules: {
      ...
      items: [
        ...
        {
          title: "2. Randomization and Design",
          points: [
        ...
        {
          title: "3. Factorial Treatment Structure",
          points: [
            "Factorial Structure",
        ...
        {
          title: "4. Factorial Treatment Structure (Advanced)",
          points: [
            ...
            "Factorial Treatment for Unbalanced Data",
            "Two-Series Factorials"
          ]
        },
        {
          title: "5. Fractional Factorials",
          points: [
            "Why Fraction?",
        ...
        {
          title: "6. Practical Exercise on Minitab Response Surface Designs",
          points: [
    ...
    clients: {
      title: "Empowering Organizations with Analytical Excellence",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "electric-vehicle": {
    title: "Electric Vehicle Training Workshop",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "ELECTRIC VEHICLE TRAINING WORKSHOP",
    bannerSubtitle: "Learn the Fundamentals of Electric Vehicles and Drive the Future of Transportation",
    bannerDescription:
      "Electric Vehicles (EVs) have been available in the market for over 110 years. In the early days of vehicle development, the main competitors were the Internal Combustion Engine (ICE) and the Electric Vehicle. EVs led the market until 1930, after which gasoline-powered vehicles became dominant. Today, with the global push for sustainability, electric vehicles are once again at the forefront of innovation. This course provides a comprehensive foundation in electric vehicle technology, market trends, and practical implementation.",
    introText:
      "Are you ready to be at the forefront of the electric vehicle revolution? Our Electric Vehicle Training Workshop is designed for professionals, entrepreneurs, and enthusiasts who want to understand, implement, and optimize electric vehicle technology. Learn from industry-leading experts and gain hands-on knowledge about the latest advancements, charging infrastructure, battery technology, and more. Join us to unlock your potential and drive the future of transportation.",
    whyChoose: {
      title: "Why Learn from Us?",
      content: "Our training workshop is led by industry experts with deep knowledge and real-world experience in electric vehicle technology. We offer a practical, hands-on approach that goes beyond theory, covering the latest advancements, battery technology, charging infrastructure, and key industry trends. Our cutting-edge curriculum ensures you gain a holistic understanding of electric vehicles and are prepared to contribute to the sustainable transportation landscape.",
      subTitle: "Ready to embark on this exciting learning experience?",
      subText: "Join our Electric Vehicle Training Workshop and unlock your potential to drive the future of transportation.",
    },
    courseObjective: {
      title: "What You Will Learn in this Training Workshop",
      points: [
        "Understand the fundamentals of electric vehicle technology and its benefits.",
        "Learn about different types of electric vehicles and their components.",
        "Gain insights into battery technology and charging infrastructure.",
        "Explore the environmental benefits of electric vehicles and their impact on sustainability.",
        "Identify key industry trends and future developments in electric vehicle technology."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
      items: [
        "Automotive professionals, engineers, and technicians looking to expand their knowledge in electric vehicle technology.",
        "Entrepreneurs or business owners interested in entering the electric vehicle market.",
        "Environmental enthusiasts or advocates for sustainable transportation.",
        "Anyone seeking a comprehensive understanding of electric vehicle technology and its impact on the transportation industry."
      ]
    },
    features: [
      {
        ...
        desc: "Learn from industry-leading experts with years of experience in electric vehicle technology and successful project implementation."
      },
      {
        icon: "Wrench",
        title: "Practical Approach",
        desc: "Gain hands-on knowledge to understand, implement, and optimize electric vehicle technology beyond just theory."
      },
      {
        icon: "BookOpen",
        title: "Cutting-Edge Curriculum",
        desc: "Covers fundamentals, types of EVs, battery technology, charging infrastructure, environmental benefits, and industry trends."
      },
      {
        icon: "Leaf",
        title: "Sustainability Focus",
        desc: "Explore the environmental benefits of EVs and their role in creating a sustainable future."
      },
      {
        icon: "TrendingUp",
        title: "Industry-Relevant Skills",
        desc: "Be prepared to contribute to the rapidly evolving electric vehicle industry and sustainable transportation landscape."
      }
    ],
    brochure: {
      title: "To Get Course Outline and Reference Material",
    ...
    clients: {
      title: "Empowering Organizations for the Future of Mobility",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },

  "design-for-quality-training": {
    title: "Design for Quality Training Courses",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "DESIGN FOR QUALITY | DFQ TRAINING COURSES",
    bannerSubtitle: "Designing Products that Delight Customers and Build Trust",
    bannerDescription:
      "Design for Quality (DFQ) Training empowers participants to create products and services that exceed customer expectations, compete on quality, and deliver long-lasting value. DFQ is essential for building customer trust and ensuring long-term success by focusing on robust design, manufacturability, and validation. This training covers the tools, techniques, and methodologies required to design for quality, reduce costs, and minimize product rejections.",
    introText:
      "Quality is not an afterthought—it's built into the product from the very beginning. Our Design for Quality (DFQ) training provides a comprehensive understanding of how to integrate quality into every stage of product and process development. Participants will learn about Six Sigma, FMEA, engineering drawings, and validation tools to ensure products meet and exceed customer requirements.",
    whyChoose: {
      title: "Why Choose Tetrahedron for Design for Quality Training?",
      content: "Tetrahedron's DFQ training is led by experienced professionals who blend theory with hands-on exercises and real-world case studies. Our approach ensures participants not only understand the importance of quality in design but also gain practical skills in applying DFQ tools and techniques to reduce costs, improve manufacturability, and enhance customer satisfaction.",
      subTitle: "Ready to design products that stand out for quality?",
      subText: "Join our DFQ training to master the art and science of quality-driven product and process design.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
        "Learn about the tools and techniques required to Design for Quality and why it is important.",
        "Understand the roles of Six Sigma, FMEA, engineering, and drawing in quality design.",
        "Analyze Process Flow Diagrams (PFD), design for manufacturability, and assembly of products.",
        "Master tools for product and process design, development, and validation."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
    ...
    features: [
      {
        icon: "DollarSign",
        title: "Reduced Production and Quality Costs",
        desc: "Better design leads to lower production and quality costs by minimizing defects and rework."
      },
      {
        icon: "BarChart2",
        title: "Optimized Manufacturing and Assembly",
        desc: "Design for manufacturability reduces time, cost, and assembly issues."
      },
      {
        icon: "ClipboardCheck",
        title: "Data-Driven Quality",
        desc: "Emphasizes the importance of data collection to meet customer expectations and requirements."
      },
      {
        icon: "Sliders",
        title: "Control Limits and Tolerances",
        desc: "Defining control limits and tolerances helps improve product quality and consistency."
      },
      {
        icon: "CheckCircle2",
        title: "Process and Product Validation",
        desc: "Testing and validating processes and products builds customer trust and reduces complaints."
      },
      {
        icon: "ShieldCheck",
        title: "Minimized Product Rejection",
        desc: "Validating products before delivery reduces rejections and complaints at the customer end."
      }
    ],
    brochure: {
      title: "To Get Course Outline and Reference Material",
    ...
    modules: {
      ...
      outline: [
        ...
        {
          title: "4. Quality Function Deployment",
          points: [
            "Concepts of QFD",
        ...
        {
          title: "5. Product Design and Development",
          points: [
        ...
        {
          title: "6. Process Design and Development",
          points: [
        ...
        {
          title: "7. Product and Process Validation",
          points: [
    ...
    clients: {
      title: "Empowering Organizations with Quality by Design",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },

  "oee-calculation-and-improvement-action": {
    title: "OEE (Overall Equipment Effectiveness) Calculation Training",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "OEE CALCULATION & IMPROVEMENT ACTION TRAINING",
    bannerSubtitle: "Learn How to Implement OEE Calculation and Optimize Manufacturing Efficiency",
    bannerDescription:
      "Overall Equipment Effectiveness (OEE) is a powerful metric used to calculate the productive time of manufacturing over the total available time. OEE helps organizations identify losses, improve processes, and increase production efficiency. This training covers the principles, calculation, and practical application of OEE, focusing on the key factors: Productivity, Performance, Availability, and Quality.",
    introText:
      "Are you ready to take your manufacturing efficiency to the next level? Our OEE Calculation Training Workshop is designed for managers, engineers, and professionals who want to optimize manufacturing processes and drive operational excellence. Learn from industry leaders with a proven track record in OEE implementation and gain practical skills to maximize your plant's performance.",
    whyChoose: {
      title: "Why Learn OEE Calculation from Us?",
      content: "Our organization is an industry leader in OEE Calculation and manufacturing optimization. Our experienced professionals bring deep expertise and a practical approach, having successfully implemented OEE in real-world scenarios. We focus on actionable strategies, hands-on exercises, and proven methodologies to help you achieve tangible improvements in your operations.",
      subTitle: "Ready to embark on this exciting learning experience?",
      subText: "Join our OEE Calculation Training Workshop and unlock your potential to achieve manufacturing excellence.",
    },
    whoShouldAttend: {
      title: "Who Should Attend",
      items: [
        "Managers, engineers, and professionals responsible for optimizing manufacturing processes",
        "Anyone seeking to implement OEE Calculation and improve manufacturing efficiency",
        "Individuals looking to enhance their knowledge and skills in OEE and gain a competitive advantage"
      ]
    },
    features: [
      {
        icon: "BarChart2",
        title: "Comprehensive OEE Understanding",
        desc: "Gain a deep understanding of OEE concepts, metrics, and their importance in manufacturing."
      },
      {
        icon: "Calculator",
        title: "Hands-On Calculation",
        desc: "Learn how to accurately calculate and interpret OEE metrics to assess and improve performance."
      },
      {
        icon: "Search",
        title: "Root Cause Analysis",
        desc: "Identify and analyze key factors affecting OEE and manufacturing efficiency."
      },
      {
        icon: "TrendingUp",
        title: "Improvement Strategies",
        desc: "Implement proven strategies to improve OEE and optimize production processes."
      },
      {
        icon: "Repeat",
        title: "Continuous Improvement",
        desc: "Use OEE as a continuous improvement tool to drive operational excellence."
      },
      {
        icon: "BookOpen",
        title: "Real-World Case Studies",
        desc: "Apply best practices and case studies to real-world manufacturing scenarios."
      }
    ],
    courseObjective: {
      title: "What You Will Learn in this Training Workshop",
      points: [
        "Understand the concept and importance of Overall Equipment Effectiveness (OEE) in manufacturing.",
        "Calculate and interpret OEE metrics to assess manufacturing performance.",
        "Identify and analyze the key factors affecting OEE and manufacturing efficiency.",
        "Implement strategies to improve OEE and optimize production processes.",
        "Use OEE Calculation as a continuous improvement tool to drive operational excellence.",
        "Apply best practices and case studies to real-world manufacturing scenarios."
      ]
    },
    brochure: {
      title: "To Get Course Outline and Reference Material",
    ...
    clients: {
      title: "Empowering Organizations with Manufacturing Excellence",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },

  "total-productive-maintenance-course-tpm": {
    title: "Total Productive Maintenance Training Course",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "TOTAL PRODUCTIVE MAINTENANCE TRAINING COURSE",
    bannerSubtitle: "Enhance Efficiency and Productivity with Total Productive Maintenance",
    bannerDescription:
      "Total Productive Maintenance (TPM) is a systematic approach to maintaining equipment and machines as per requirement. TPM helps improve equipment lifetime and durability, while preventing accidents, breakdowns, and slow production. By maximizing the operational efficiency of equipment, TPM plays a vital role in driving productivity and operational excellence.",
    introText:
      "Are you ready to take your organization’s productivity to the next level? If you’re looking to enhance efficiency and eliminate waste, our Total Productive Maintenance (TPM) Training Course is the perfect opportunity for you. Learn from industry leaders with deep expertise in TPM principles and best practices, and gain practical skills to drive improvements and achieve operational excellence. Our course goes beyond theory, equipping you with actionable strategies to implement TPM, engage employees, and foster a culture of continuous improvement.",
    whyChoose: {
      title: "Why Learn from Us?",
      content: "At Tetrahedron, we are leaders in TPM knowledge and best practices. Our experienced professionals have a deep understanding of TPM principles and their application across various industries. Our instructors are TPM experts with a proven track record of success in implementing TPM practices, driving significant improvements in productivity, quality, and equipment effectiveness. We deliver training that is credible, authoritative, and focused on practical implementation—helping you identify and eliminate losses, engage employees, and create a culture of continuous improvement.",
      subTitle: "Ready to embark on this exciting learning experience?",
      subText: "Join our Total Productive Maintenance Training Course and unlock your potential for operational excellence. Together, let’s maximize efficiency and drive sustainable growth.",
    },
    courseObjective: {
      title: "What You Will Learn in this Training Course",
      points: [
        "Understand the principles and benefits of Total Productive Maintenance (TPM).",
        "Identify and eliminate losses in your organization’s processes and equipment.",
        "Implement TPM pillars, including Autonomous Maintenance, Planned Maintenance, and more.",
        "Engage and empower employees to take ownership of equipment maintenance.",
        "Create a culture of continuous improvement and problem-solving.",
        "Measure and improve Overall Equipment Effectiveness (OEE).",
        "Develop an effective TPM implementation plan for your organization."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
      items: [
        "Managers, supervisors, and professionals responsible for operations and maintenance.",
        "Engineers and technicians involved in equipment management and reliability.",
        "Continuous improvement and lean practitioners seeking to enhance efficiency.",
        "Anyone interested in improving productivity and eliminating waste through TPM."
      ]
    },
    features: [
      {
        ...
        desc: "Learn from industry leaders with deep TPM knowledge and hands-on experience across various sectors."
      },
      {
        icon: "CheckCircle",
        title: "Credibility and Authority",
        desc: "Training delivered by TPM experts with a proven track record of successful TPM implementation."
      },
      {
        icon: "Tool",
        title: "Practical Strategies",
        desc: "Gain actionable strategies and tools to implement TPM and drive real improvements."
      },
      {
        icon: "Users",
        title: "Employee Engagement",
        desc: "Learn how to engage and empower employees to take ownership of equipment and processes."
      },
      {
        icon: "RefreshCw",
        title: "Continuous Improvement",
        desc: "Foster a culture of ongoing improvement and problem-solving throughout your organization."
      },
      {
        icon: "BarChart2",
        title: "Measurable Results",
        desc: "Learn to measure and improve OEE and other key performance indicators through TPM."
      }
    ],
    brochure: {
      title: "To Get Course Outline and Reference Material",
    ...
    clients: {
      title: "Empowering Organizations with TPM Excellence",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },

  "ul-60335-2-40-csa-training-harmonised-iec-standard": {
    title: "UL 60335-2-40/CSA C22.2 – Harmonised IEC Standard Training",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "UL 60335-2-40/CSA C22.2 – Harmonised IEC Standard",
    bannerSubtitle: "Know the Testing Requirement under UL 60335-2-40",
    bannerDescription:
      "As regulatory norms for the HVAC industry evolve, there is a primary focus on low global warming potential refrigerants and achieving global harmonisation of safety requirements in safety appliances. UL 60335-2-40 is a more rigorous testing standard for HVAC appliances. The UL 60335-2-40 and harmonised CSA C22.2 standards apply to packaged air conditioners and heat pumps, partial units, liquid chillers and hydronic fan coil units, hot water heat pumps, dehumidifiers, supplement heaters, and equipment with flammable refrigerants.",
    introText:
      "This training provides a comprehensive understanding of the UL 60335-2-40/CSA C22.2 harmonised IEC standard, focusing on the latest testing requirements for HVAC appliances. Participants will learn how to maintain UL certifications during testing and certifying new equipment, assure customers of high product security, and gain a competitive advantage with UL 60335-2-40 compliant products. The course also helps HVAC manufacturers achieve an optimal balance of system properties while integrating all defined safety requirements.",
    whyChoose: {
      title: "Why Choose This Training?",
      content: "Our training is designed to help you understand and implement the latest UL 60335-2-40/CSA C22.2 harmonised IEC standards. Led by industry experts, this course ensures you are equipped to maintain certifications, meet customer expectations, and stay ahead in a competitive market. The training is practical, up-to-date, and tailored for professionals involved in HVAC product development and compliance.",
      subTitle: "Ready to ensure your HVAC products meet the latest safety standards?",
      subText: "Join our UL 60335-2-40/CSA C22.2 training to gain the knowledge and skills needed for compliance and certification.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
        "Benefit from maintaining UL certifications during testing and certifying new equipment.",
        "Assure your customers that your product is built with a high level of security.",
        "Gain a competitive advantage with UL 60335-2-40 compliant products.",
        "Help HVAC manufacturers achieve an optimal balance of system properties while integrating all defined safety requirements for a full detector package."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
      items: [
        ...
        "NTP Project Developers",
        "VAVE Project Developers",
        "HVAC Developers",
    ...
    features: [
      {
        icon: "BookOpen",
        title: "Latest Standard Insights",
        desc: "Gain understanding of the latest test base standard and its implications for HVAC products."
      },
      {
        icon: "CheckCircle",
        title: "Practical Application",
        desc: "Benefit from training that helps engineers execute projects requiring evaluation and testing of existing components to align with the new standard."
      },
      {
        icon: "ShieldCheck",
        title: "Enhanced Compliance",
        desc: "Ensure your products meet rigorous safety and compliance requirements, building customer trust."
      },
      {
        icon: "TrendingUp",
        title: "Competitive Advantage",
        desc: "Achieve a market edge with UL 60335-2-40 compliant products and processes."
      }
    ],
    outline: {
      title: "Training Outline",
      modules: [
        {
          title: "1. Introduction to the Standard",
          points: [
            "Introduction to UL 60335-2-40/CSA C22.2 No. 60335-2-40 Standard",
            "Harmonised IEC Standard",
            "Its impact and overview"
          ]
        },
        {
          title: "2. Applying the Standard",
          points: [
            "Difference in the previous standard and the new standard clause by clause – UL 1995 vs. UL 60335-2-40"
          ]
        },
        {
          title: "3. Step by Step Discussion on the New Standard UL 60335-2-40",
          points: [
            "General conditions for the test, Classification",
            ...
            "Transient overvoltage, Moisture resistance",
            "Leakage current and electric strength"
          ]
        },
        {
          title: "4. Overload Protection and Mechanical Requirements",
          points: [
            "Overload protection of transformers and associated circuits",
            "Endurance, Abnormal operation",
            "Stability and mechanical hazards",
            "Mechanical strength, Construction, Internal wiring",
            "Components, Supply connection and external flexible cords",
            "Terminals for external conductors",
            "Provision for earthing, Screws and connections",
            "Clearances, creepage distances and solid insulation",
            "Resistance to heat and fire",
            "Resistance to rusting, Radiation",
            "Toxicity and similar hazards"
          ]
        },
        {
          title: "5. Future Expectations",
          points: [
            "Expansion of UL 60335-2-40 to different standards",
            "Expansion to new refrigerants",
            "Expansions to new appliances",
            "Expansions to new tests",
            "Clarifications on test parameters"
          ]
        }
      ]
    },
    ...
    clients: {
      title: "Empowering HVAC Organizations with Compliance Excellence",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "ul-508a-training": {
    title: "Industrial Control Panel Standard UL 508A Training",
    image: "/assets/images/backgrounds/page-header-bg1.jpg",
    bannerTitle: "INDUSTRIAL CONTROL PANEL STANDARD UL 508A TRAINING",
    bannerSubtitle: "Get to know the critical compliance requirements of UL 508A safety standard",
    bannerDescription:
      "UL 508A is a standard for the construction of industrial control panels, offering guidelines to panel builders on proper component selection, grounding, wiring methods, and cable routing. UL 508A provides a third-party inspection authority to give customers proof that the assembled industrial control panel meets electrical safety standards and complies with the national electrical code.",
    introText:
      "Our UL 508A Panel Design Fundamentals Training covers the standard requirements and demonstrates how we help you achieve compliance. Gain a competitive advantage with UL 508A-compliant products, assure your customers of high electrical safety, and maintain your UL certifications during inspections and audits. This training is essential for anyone involved in the design, development, or compliance of industrial control panels.",
    whyChoose: {
      title: "Why Choose Our UL 508A Training?",
      content: "Our training is led by industry experts with deep experience in UL 508A compliance and industrial control panel design. We provide practical, hands-on guidance to help you understand the standard, avoid common pitfalls, and ensure your panels are built to the highest safety standards. Stay ahead of regulatory changes and gain the knowledge needed to maintain UL certifications and deliver products that meet global safety expectations.",
      subTitle: "Ready to ensure your panels meet UL 508A standards?",
      subText: "Join our UL 508A training and build panels with confidence and compliance.",
    },
    courseObjective: {
      title: "Course Objective",
      points: [
        "Understand the critical compliance requirements of UL 508A.",
        "Learn proper component selection, grounding, wiring methods, and cable routing.",
        "Maintain UL certifications during inspections and audits.",
        "Assure customers that your product is built with a high level of electrical security.",
        "Enable your panels to be UL Marked as a complete appliance.",
        "Gain a competitive advantage with UL 508A-compliant products."
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
    ...
    features: [
      {
        ...
        desc: "The UL 508A mark is accepted and recognized across the world, providing assurance of compliance and safety."
      },
      {
        icon: "Award",
        title: "Competitive Advantage",
        desc: "UL 508A compliance gives your products a market edge and builds customer trust."
      },
      {
        icon: "CheckCircle",
        title: "Assured Compliance",
        desc: "Meet inspection and audit requirements with confidence and maintain your UL certifications."
      },
      {
        icon: "BookOpen",
        title: "Comprehensive Curriculum",
        desc: "Covers all aspects of UL 508A, from component selection to wiring, grounding, and marking."
      }
    ],
    trainingOutline: {
      title: "Training Outline",
      sections: [
        ...
        {
          title: "3. Terminal Temperature Limitations",
          points: [
        ...
        {
          title: "4. Transformer and Power Supply Secondary Grounding",
          points: [
        ...
        {
          title: "5. Enclosure Environmental Control Devices",
          points: [
        ...
        {
          title: "6. Future Expectation",
          points: [
            "Future expansion of UL 508A to different standards",
            "Expansion to new safety requirements"
          ]
        }
      ]
    },
    ...
    clients: {
      title: "Empowering Organizations with Compliance Excellence",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "cost-reduction-strategies": { // New entry for Cost Reduction Training
  ...
  //---2
  "7-new-qctools": { // New entry for 7 New QC Tools Training
  ...
  //--3
  "line-balancing": { // New entry for Line Balancing Training
  ...
  //--4
  "root-cause-analysis": { // New entry for Root Cause Analysis Training
  ...
  //--5
  "simple-low-cost-automation": { // New entry for Low Cost Automation Training
  ...
  //--6
  "5s-training-program": { // New entry for 5S Training
  ...
  //--9
  "total-quality-management-tqm": { // New entry for TQM Training
  ...
  // --11
  "cost-reduction-by-lean-manufacturing": { // New entry for Cost Reduction by Lean Training
  ...
  // --12
  "why-why-analysis-fish-born-5-why-training": { // New entry for 5 Why & Fishbone Training
  ...
  // --13
  "kaizen-training-program": { // New entry for Kaizen Training
  ...
  "value-engineering-value-analysis": { // New entry for Value Engineering & Value Analysis Training
    title: "Value Engineering & Value Analysis Training",
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Standard format
    bannerTitle: "VALUE ENGINEERING & VALUE ANALYSIS TRAINING",
    bannerSubtitle: "Maximizing Value, Reducing Cost, Enhancing Performance",
    bannerDescription:
      "Value Engineering (VE) and Value Analysis (VA) are powerful methodologies for solving problems and reducing costs without compromising performance and quality. Through function analysis, VE/VA helps analyze and improve existing products, systems, and processes, as well as develop new designs for optimal value.",
    introText:
      "Value Engineering & Value Analysis (VE/VA) is a structured, creative, and consensus-building approach to optimizing value in products, projects, and processes. By focusing on function, cost, and quality, VE/VA enables organizations to achieve significant cost reductions, improve performance, and foster innovation. This training equips participants with the knowledge and tools to apply VE/VA principles, conduct function analysis, and implement value improvement strategies across a wide range of applications.",
    whyChoose: {
      title: "Why Choose Tetrahedron for Value Engineering & Value Analysis Training?",
      content:
        "Tetrahedron's VE/VA training is highly practical, combining expert instruction with real-world case studies and hands-on exercises. Our facilitators guide participants through the entire VE/VA process, from function analysis to creative problem-solving and implementation planning. We emphasize a collaborative approach that leverages the collective expertise of owners, designers, and cross-functional teams to achieve optimal value and cost-effectiveness.",
      subTitle: "Ready to unlock greater value in your projects and processes?",
      subText: "Master the art and science of Value Engineering & Value Analysis with our comprehensive training.",
    },
    // Target Audience
    targetAudience: [
      "Project Managers",
    ...
    features: [
      {
        icon: "TrendingDown", // Lucide icon guess
        title: "Reduction in Overall Life Cycle Cost",
        desc: "Achieve significant cost savings by focusing on essential functions and eliminating unnecessary expenses."
      },
      {
        icon: "DollarSign",
        title: "Lower Total Installed Cost",
        desc: "Optimize design and implementation to minimize total project and facility costs."
      },
      {
        icon: "CheckSquare",
        title: "Fit-for-Purpose Solutions",
        desc: "Develop solutions that deliver required functions at minimum life cycle cost without sacrificing quality."
      },
      {
        icon: "Users",
        title: "Collaborative, Structured Problem Solving",
        desc: "Leverage group creativity and consensus-building to generate and evaluate value improvement ideas."
      },
      {
        icon: "Zap",
        title: "Enhanced Functionality & Performance",
        desc: "Increase the functional value and performance of products, systems, and processes."
      },
      {
        icon: "Puzzle",
        title: "Broad Applicability",
        desc: "Apply VE/VA concepts to any project, process, procedure, system, or service for continuous improvement."
      }
    ],
    courseContent: {
      title: "Value Engineering & Value Analysis Training Outline",
      modules: [
        ...
        "  – Difference between VE, VA, and Traditional Cost Reduction Approaches",
        "2. Understanding of Key Terminology",
        "  – Value Techniques",
        ...
        "  – Cost Models",
        "  – Annual Purchase Values and Quantities",
        "  – Sample Components",
        "  – Reject Rates",
        "  – Warranty Data",
        ...
        "  – 16 Ways to Solve Problems Creatively",
        "  – Major Tools: Brainstorming, Nominal Group Technique, Cause and Effect Analysis, Pareto Charts, Total Cost Concept, Life Cycle Costing (LCC)",
        "9. Evaluation Phase",
        "  – Eliminate the Noise",
        "  – Estimate of Savings",
    ...
    methodology: {
      ...
      image: "/assets/images/resources/f.jpg", // Standard methodology image
      points: [
        "Expert-led Presentations on VE/VA Principles and Tools",
        "Interactive Discussions and Q&A",
        "Hands-on Function Analysis and FAST Diagramming Exercises",
        "Group Brainstorming and Creative Problem-Solving Sessions",
        "Analysis of Real-world Case Studies",
        "Guidance on Developing and Implementing Value Improvement Plans"
      ]
    },
    clients: {
      title: "Delivering Value Solutions Across Industries",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "performance-management-and-improvement-plan": {
    ...
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Placeholder, update as needed
    bannerTitle: "PERFORMANCE MANAGEMENT AND IMPROVEMENT PLAN",
    bannerSubtitle: "Empowering Employees to Achieve Excellence",
    bannerDescription:
      "Performance Improvement Plan and Management is a tool used to create an environment for employees to perform to the best of their abilities and deliver high-quality work. It also helps to track and evaluate work as per the employee’s abilities and efficiency, motivating employees and enhancing their productivity and efficiency.",
    introText:
      "Performance Management and Improvement Plan training equips participants with the knowledge and tools to design and implement effective performance analysis systems and improvement plans (PIP). The program covers the relationship between reward systems and performance management, strategies for managing underperformers, and techniques for standardizing performance reviews across the organization. By quantifying human competencies and measuring the ability to convert knowledge into tangible business results, this training helps organizations drive focused performance improvement and employee engagement.",
    courseObjective: {
      title: "Course Objective",
      points: [
        "Learn how to design and develop an effective performance analysis system and performance improvement plan (PIP).",
        "Understand the concept of a reward system and its relationship to the performance improvement plan process and management system.",
        "Learn how to manage underperformers and drive improvement.",
      ]
    },
    whoShouldAttend: {
      title: "Who Should Attend",
    ...
    benefits: {
      ...
      points: [
        "Increase self-esteem, productivity, and efficiency of employees through structured performance improvement planning.",
        "Plan for focused performance improvement techniques.",
        "Quantify human competencies into performance numbers.",
        "Standardize the performance review system across plants, locations, departments, and SBUs.",
        "Measure individual knowledge and capability of converting knowledge into tangible business results.",
        "Identify the performance improvement plan process and techniques for conducting quick and focused performance reviews.",
        "Plan impactful initiatives for performance improvement."
      ]
    },
    // Reference to full list of training can be added as a link or note in the UI
    courseContent: {
      title: "Performance Management and Improvement Plan Training Outline",
      modules: [
        "1. The Basis of Performance Management",
        "  – Performance management defined",
        "  – Aims of performance management",
        "  – Characteristics and concerns of performance management",
        ...
        "  – Rating, forced distribution, forced ranking, quota systems",
        "  – Visual methods of assessment",
        "  – Conclusion",
        "7. Improving Performance",
        "  – Improving performance at the organizational level",
        "  – Problems at the managerial level",
    ...
    methodology: {
      ...
      image: "/assets/images/resources/f.jpg", // Standard methodology image
      points: [
        "Expert-led presentations on performance management principles and tools",
        "Interactive discussions and Q&A",
        "Hands-on exercises in designing performance improvement plans",
        "Role plays and case studies for managing underperformers",
        "Guidance on standardizing performance review systems",
        "Templates and best practices for HR performance management administration"
      ]
    },
    clients: {
      title: "Empowering Organizations to Achieve Peak Performance",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "cost-reduction-by-lean-manufacturing": {
    title: "Cost Reduction by Lean Manufacturing",
    image: "/assets/images/backgrounds/page-header-bg1.jpg", // Standard header image
    bannerTitle: "COST REDUCTION BY LEAN MANUFACTURING",
    bannerSubtitle: "Learn How to Implement Cost Reduction Strategies in Manufacturing",
    bannerDescription:
      "Lean manufacturing principles can reduce manufacturing costs by increasing labor productivity, cutting production throughput times, reducing inventories, and cutting errors and scrap by as much as half. It characterizes all activities as either value-added or non-value-added with the focus on eliminating non-value-added activities (wastes).",
    introText:
      "Are you looking to enhance efficiency and achieve cost savings in manufacturing? If you’re passionate about optimizing processes and reducing expenses, then our Cost Reduction in Manufacturing Training Workshop is the perfect opportunity for you. At Tetrahedron, we have extensive experience in cost reduction strategies in manufacturing. Our team of seasoned professionals has deep knowledge of various techniques and approaches that can drive efficiency and savings. By learning from us, you’ll gain invaluable insights and practical skills that will help you streamline operations and reduce costs.\n\nWe believe in delivering tangible results. When you participate in our workshop, you’ll receive training from industry experts who have a track record of successfully implementing cost reduction strategies in manufacturing. Our instructors have not only mastered cost reduction principles but have also achieved significant savings for organizations.\n\nCost reduction is not just a theoretical concept—it’s a practical approach that requires implementation. Our workshop goes beyond theory and equips you with actionable strategies to identify cost-saving opportunities, optimize processes, and eliminate waste in your manufacturing operations. You’ll learn proven methodologies and best practices that can deliver immediate results.\n\nDon’t miss out on this transformative opportunity to become a cost reduction expert in manufacturing. Join our Cost Reduction in Manufacturing Training Workshop and unlock your potential to drive efficiency and savings. Together, let’s optimize manufacturing processes and achieve cost reduction that boosts competitiveness.",
    whyChoose: {
      title: "Why Learn Cost Reduction from Tetrahedron?",
      content:
        "Tetrahedron’s Cost Reduction in Manufacturing Training Workshop is led by industry experts with a proven track record of delivering significant savings for organizations. Our approach combines in-depth expertise, practical strategies, and real-world case studies to ensure you gain actionable skills. We focus on implementation, not just theory, so you can immediately apply what you learn to drive efficiency and cost savings in your operations.",
      subTitle: "Ready to embark on this exciting learning experience?",
      subText: "Join our workshop and unlock your potential to drive efficiency and savings."
    },
    whoShouldAttend: {
      title: "Who Should Attend?",
      points: [
        "Managers, executives, or professionals responsible for driving efficiency and cost reduction initiatives in manufacturing organizations.",
        "Engineers, consultants, or analysts working on cost reduction projects.",
        "Anyone seeking to enhance their knowledge and skills in cost reduction and receive a certification.",
        "Professionals who want to learn how to identify and eliminate waste, optimize processes, and reduce costs in manufacturing.",
        "Individuals looking to explore the potential of cost reduction in manufacturing and identify opportunities for efficiency improvements."
      ]
    },
    learningOutcomes: {
      title: "What You Will Learn in This Training Workshop",
      points: [
        "Understand the importance of cost reduction in manufacturing and its impact on competitiveness.",
        "Identify cost-saving opportunities and eliminate waste in manufacturing processes.",
        "Implement lean manufacturing principles and techniques to optimize efficiency and reduce costs.",
        "Analyze data and use performance metrics to measure and track cost reduction initiatives.",
        "Develop and implement a cost reduction action plan that aligns with your organization’s goals.",
        "Communicate and present cost reduction achievements to stakeholders."
      ]
    },
    courseContent: {
      title: "Cost Reduction by Lean Manufacturing Training Outline",
      modules: [
        ...
        "Focus on Cost Reduction through Waste Elimination",
        "Understanding Value Added vs. Non-Value Added Activities",
        "Detailed Exploration of the 7+1 Wastes (Muda): Overproduction, Waiting, Transportation, Over-processing, Inventory, Motion, Defects, Unused Talent",
        "Introduction to Value Stream Mapping (VSM): Current State & Future State Basics",
        "5S Workplace Organization for Efficiency and Waste Reduction",
        "Kaizen: Philosophy and Methodology for Continuous Improvement Events",
        "Poka-Yoke (Mistake-Proofing): Principles and Examples",
    ...
    features: [
      ...
      {
        icon: "Users",
        title: "Employee Engagement & Empowerment",
        desc: "Lean initiatives encourage team involvement in identifying and solving problems."
      },
      {
        icon: "BarChart2",
        title: "Data-Driven Decision Making",
        desc: "Use of metrics and analysis to identify, prioritize, and sustain cost reduction."
      },
      {
        icon: "Award",
        title: "Competitive Advantage",
        desc: "Lower costs and higher efficiency improve market position and profitability."
      }
    ],
    clients: {
      title: "Driving Lean Savings for Our Partners",
      image: "/assets/images/client.jpg"
    }
    // FAQ section can be added if required in the future
  },
  ...
  "esg-certification-training": { // New entry for ESG Training
  ...
  //--2
  "daily-work-management": { // New entry for Daily Work Management Training
  ...
  //--3
  "design-thinking": { // New entry for Design Thinking Training
  ...
  //--4
  "finance-for-non-finance-manager": { // New entry for Finance for Non-Finance Training
  ...
  //--5
  "theory-of-inventive-problem-solving": { // New entry for TRIZ Training
  ...
  //--6
  "balance-score-card": { // New entry for Balanced Scorecard Training
  ...
  //--7
  "competency-mapping": { // New entry for Competency Mapping Training
  ...
  //--8
  "productivity-focus-skill-mapping": { // New entry for Productivity Focus Skill Mapping
  ...
  //--9
  "world-class-manufacturing": { // New entry for World Class Manufacturing Training
  ...
  //--2
  "art-of-delegation-training": { // New entry for Art of Delegation Training
  ...
  //--3
  "planning-and-prioritization-skill": { // New entry for Planning & Prioritization Training
  ...
  //--4
  "team-time-and-task-management": { // New entry for Team Time & Task Mgmt Training
  ...
  //--- 5
  //not available
  "team-development-motivation": { // New entry for Team Development & Motivation Training
