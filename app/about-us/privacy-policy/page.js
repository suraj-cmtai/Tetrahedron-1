                    ...
                    <div className="shadow-md rounded-lg overflow-hidden">
                        ...
                        <div className="border-b border-gray-100">
                            ...
                            <div className="px-6 py-4 bg-white">
                                ...
                                <p className="mb-4 text-gray-700">
                                    PCI-DSS requirements help ensure the secure handling of credit card information by our website and its service providers. For more insight, you may also want to read terms and conditions of Razorpay on <a href="https://razorpay.com" className="text-blue-500 hover:underline">https://razorpay.com</a>.
                                </p>
                            </div>
                        </div>
