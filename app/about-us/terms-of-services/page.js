          ...
          <div className="shadow-md rounded-lg overflow-hidden">
            ...
            <div className="border-b border-gray-100">
              ...
              <div className="px-6 py-4 bg-white">
                ...
                <p className="mb-4 text-gray-700">
                  By accessing or using the Website or Services, you agree to be bound by these Terms and our <Link href={privacyPolicyPath} className="text-blue-500 hover:underline">Privacy Policy</Link>. If you do not agree to these Terms or the Privacy Policy, you must not access or use the Website or Services. Please read these Terms carefully.
                </p>
              </div>
            </div>
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">2. Use of the Website and Services</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">3. Intellectual Property Rights</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">4. User Contributions (If Applicable)</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">5. Disclaimers</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">6. Limitation of Liability</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">7. Indemnification</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">8. Governing Law and Jurisdiction</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
            ...
            <div className="border-b border-gray-100">
              <div className="bg-gray-50 px-6 py-4">
                <h2 className="text-xl font-bold text-gray-800">9. Changes to the Terms of Service</h2>
              </div>
              <div className="px-6 py-4 bg-white">
                <p className="mb-4 text-gray-700">
              ...
              <div className="px-6 py-4 bg-white">
                ...
                <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
                  <p className="mb-1 text-gray-700">
                    <span className="font-semibold">Email:</span> <a href={`mailto:${companyEmail}`} className="text-blue-500 hover:underline">{companyEmail}</a>
                  </p>
                  <p className="text-gray-700">
                    <span className="font-semibold">Website:</span> <a href={companyWebsiteUrl} className="text-blue-500 hover:underline">{companyWebsiteUrl}</a>
                  </p>
                </div>
              </div>
            </div>
